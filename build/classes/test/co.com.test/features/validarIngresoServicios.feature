#language: es
 ...
 Característica: Ingresar a revisar los servicios que ofrece Choucair Testing
   Como usuario  web
   Quiero ingresar a la página de Choucair Testing
   A revisar los servicios que ofrece la compañía
