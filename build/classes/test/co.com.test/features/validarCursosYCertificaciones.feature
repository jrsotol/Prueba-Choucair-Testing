...
Característica: Validar botón "Cursos y Certificaciones"


  @ValidarCursosYCertificaciones
  Escenario: Validar Botón "Cursos y Certificaciones" del Portafolio de Soluciones
    ...
    Y dar Click en el botón LEER MÁS
    Entonces deberia ver en pantalla el titulo que dice Cursos y Certificaciones
